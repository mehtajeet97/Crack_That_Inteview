...
return(
  ...
  <div className="w-full rounded-lg sm:max-w-md xl:p-0">
    ...
    {!isEdit &&
      ...
      <svg className="w-10 h-10 fill-current" role="img" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
    ...
    {isEdit &&  <div className="w-full rounded-lg sm:max-w-md xl:p-0">
      ...
      <svg className="w-10 h-10 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" /></svg>
    </button>
    }
    </div>
    <div className="w-full rounded-lg sm:max-w-md xl:p-0">
    ...
    <div className="w-full rounded-lg sm:max-w-md xl:p-0">
      {currentProfileState?.upcomingInterviews?.length ? <><label className="text-white font-semibold mb-2" for="upcoming-interviews">Upcoming Interviews</label><div className="mb-5 flex list-none flex-col flex-wrap pl-0 md:flex-row">{currentProfileState?.upcomingInterviews?.map((interview) => <div className="my-2 block rounded bg-neutral-100 px-5 pb-3.5 pt-4 text-xs font-medium uppercase leading-tight text-black-500 data-[te-nav-active]:!bg-primary-100 data-[te-nav-active]:text-primary-700 dark:bg-neutral-700 dark:text-white dark:data-[te-nav-active]:text-primary-700 md:mr-4">{interview}</div>)}</div></>: <div></div>
      }
    </div>
    <div className="w-full rounded-lg sm:max-w-md xl:p-0">
      {currentProfileState?.recentInterviews?.length ? <><label className="text-white font-semibold mb-2" for="recent-interviews">Recent Interviews</label><div className="mb-5 flex list-none flex-col flex-wrap pl-0 md:flex-row">{currentProfileState?.recentInterviews?.map((interview) => <div className="my-2 block rounded bg-neutral-100 px-5 pb-3.5 pt-4 text-xs font-medium uppercase leading-tight text-black-500 data-[te-nav-active]:!bg-primary-100 data-[te-nav-active]:text-primary-700 dark:bg-neutral-700 dark:text-white dark:data-[te-nav-active]:text-primary-700 md:mr-4">{interview}</div>)}</div></>: <div></div>
      }
    </div>
    <div className="w-full rounded-lg sm:max-w-md xl:p-0">
