...
async function main() {
  ...
  try {
    let user1 = {firstName: "Admin", lastName: "Admin", age: 24, email: "sidduprabhak@gmail.com", password: "Test@1234$", phoneNumber: 1234560789, resume: "", yoe: "", careerRole: "Data Science", skills: ["Python","AWS"], organization: "Crack That Interview", role: "admin", school: ""}
    let userDetails1 = await users.createUser(user1);
  } catch (e) {
    console.log(e);
  }

  try {
    let user2 = {firstName: "Bhanu", lastName: "Srinivasa", age: 23, email: "bkoppolu@stevens.edu", password: "Test@1234$", phoneNumber: 5513446259, resume: "", yoe: "", careerRole: "Data Science", skills: ["Python","AWS","JAVA","Hadoop"], organization: "Google", role: "interviewer", school: ""}
    let userDetails2 = await users.createUser(user2);
  } catch (e) {
    console.log(e);
  }

  try {
    let user3 = {firstName: "Jeet", lastName: "Mehta", age: 24, email: "jmehta10@stevens.edu", password: "Test@1234$", phoneNumber: 2019233783, resume: "", yoe: "", careerRole: "Data Science", skills: ["Python","AWS","C++"], organization: "", role: "student", school: "Stevens"}
    let userDetails3 = await users.createUser(user3);
  } catch (e) {
    console.log(e);
  }

  try {
    let user4 = {firstName: "Siddharth", lastName: "Prabhakaran", age: 24, email: "sprabha2@stevens.edu", password: "Test@1234$", phoneNumber: 9083319047, resume: "", yoe: "", careerRole: "Data Science", skills: ["Python","AWS"], organization: "", role: "student", school: "Stevens"}
    let userDetails4 = await users.createUser(user4);
  } catch (e) {
    console.log(e);
  }

  try {
    let user5 = {firstName: "Dhruv", lastName: "Vaghela", age: 25, email: "dvaghela@stevens.edu", password: "Test@1234$", phoneNumber: 2012019487, resume: "", yoe: "", careerRole: "Data Science", skills: ["Python","AWS","JAVA","C++"], organization: "Amazon", role: "interviewer", school: ""}
    let userDetails5 = await users.createUser(user5);
  } catch (e) {
    console.log(e);
  }
  ...
  try {
    let interviewDetails2 = await interviews.createInterview(
      "Siddharth",
      "Bhanu",
      "05/15/2022",
      "Pending"
  ...
  try {
    let interviewDetails3 = await interviews.createInterview(
      "Siddharth",
      "Dhruv",
      "05/05/2022",
      "Completed"
  ...
  try {
    let interviewDetails4 = await interviews.createInterview(
      "Jeet",
      "Dhruv",
      "05/03/2022",
      "Completed"
